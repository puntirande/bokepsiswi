...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepsiswi.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "logo": "https://bokepsiswi.pages.dev/favicon.ico",
        "url": "https://bokepsiswi.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepsiswi.pages.dev"
        ...
        "url": "https://bokepsiswi.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://bokepsiswi.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepsiswi.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepsiswi.pages.dev/?q={search_term}", 
